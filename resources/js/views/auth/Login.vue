<template>
  <div class="container mx-auto">
    ...
    <form @submit.prevent="onSubmit" class="max-w-md mx-auto">
      ...
      <button type="submit" class="mt-4 px-4 py-2 bg-indigo-600 text-white 
                  rounded-md hover:bg-indigo-700 focus:outline-none focus:ring 
...
export default {
  ...
  setup() {
    ...
    let { user, showNotification, notificationMessage,  notificationType, error}= storeToRefs(authStore)
